...
- ✅ **Login + sincronização na nuvem (Fase 1)** — **ATIVO**: entrar com **link
  por e-mail** (Supabase) sincroniza **gamificação + progresso** entre aparelhos,
  com **merge seguro**. Login opcional (convidado primeiro). Testado no celular.
  **Fase 2 (futuro):** sincronizar também os **quadros importados**.
